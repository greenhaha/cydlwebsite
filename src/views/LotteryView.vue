        ...
        <div class="monopoly-board relative mx-auto !mb-6" style="min-width: 300px; min-height: 300px;">
          ...
          <div class=" flex">
            <div 
              ...
              style="background-image: url('https://oss.kigermap.com/frontend/assets/image/lottoybg.png'); background-size: 100% 100%;"
            ...
            >
              ...
              <div class="absolute inset-0 flex items-center justify-center">
                <div v-if="prizes[index].type === 'points'" class="text-center w-full h-full flex flex-col items-center justify-center">
                  <img src="https://oss.kigermap.com/frontend/assets/image/qiyun.png" class="w-[70%] h-[70%] mx-auto !mb-6" alt="祈愿值">
                  <span style="background-image: url('https://oss.kigermap.com/frontend/assets/image/icon.png'); background-size: 100% 100%;" class="text-xs font-bold text-[white] drop-shadow-lg absolute bottom-2 left-0 block w-full text-center block py-2 ">{{ prizes[index].value }}祈愿值</span>
                </div>
                <div v-else-if="prizes[index].type === 'item'" class="text-center w-full h-full flex justify-center ">
                  <img src="https://oss.kigermap.com/frontend/assets/image/eika_mode.webp" style="height: 60%; margin-top: 10px; " alt="道具">
                  <span style="background-image: url('https://oss.kigermap.com/frontend/assets/image/icon.png'); background-size: 100% 100%;" class="text-xs font-bold text-[white] drop-shadow-lg absolute bottom-2 left-0 block w-full text-center block py-2 ">{{ prizes[index].value }}</span>
                </div>
              ...
              <div 
                ...
                style="background-image: url('https://oss.kigermap.com/frontend/assets/image/light.png')"
              ></div>
        ...
        <div class="text-center !mb-6">
          ...
          >
            ...
            <div class="w-32 h-32 bg-cover bg-center bg-no-repeat mx-auto transition-transform duration-300 group-hover:scale-105 group-disabled:scale-95 group-disabled:opacity-60"
                 style="background-image: url('https://oss.kigermap.com/frontend/assets/image/lottoybtn.png'); background-size: 100% 100%;">
            </div>
          </button>
              ...
              <div class="flex items-center !mb-3">
                <div class="w-16 h-16 !mr-4  bg-gradient-to-br from-purple-500/20 to-pink-500/20 rounded-lg flex items-center justify-center mr-4 border border-purple-400/30">
                  <img 
                    ...
                    src="https://oss.kigermap.com/frontend/assets/image/eika_mode.webp" 
                    class="w-12 h-12 object-contain" 
                    alt="物品"
                  >
                  <img 
                    v-else
                    src="https://oss.kigermap.com/frontend/assets/image/qiyun.png" 
                    class="w-12 h-12 object-contain" 
                    alt="祈愿值"
                  >
                </div>
...
const prizes = ref([
  { type: 'points', value: 10000, icon: 'https://oss.kigermap.com/frontend/assets/image/qiyun.png', name: '巨额祈愿值' },  // 0
  { type: 'points', value: 5000, icon: 'https://oss.kigermap.com/frontend/assets/image/qiyun.png', name: '大额祈愿值' },   // 1
  { type: 'item', value: '模型皮肤', icon: 'https://oss.kigermap.com/frontend/assets/image/eika_mode.webp', name: '稀有皮肤' }, // 2
  { type: 'points', value: 20, icon: 'https://oss.kigermap.com/frontend/assets/image/qiyun.png', name: '少量祈愿值' },     // 3
  { type: 'points', value: 1000, icon: 'https://oss.kigermap.com/frontend/assets/image/qiyun.png', name: '丰厚祈愿值' },  // 4
  { type: 'points', value: 500, icon: 'https://oss.kigermap.com/frontend/assets/image/qiyun.png', name: '优质祈愿值' },   // 5
  { type: 'points', value: 300, icon: 'https://oss.kigermap.com/frontend/assets/image/qiyun.png', name: '良好祈愿值' },   // 6
  { type: 'points', value: 50, icon: 'https://oss.kigermap.com/frontend/assets/image/qiyun.png', name: '微量祈愿值' },    // 7
  { type: 'points', value: 150, icon: 'https://oss.kigermap.com/frontend/assets/image/qiyun.png', name: '普通祈愿值' },  // 8
  { type: 'points', value: 100, icon: 'https://oss.kigermap.com/frontend/assets/image/qiyun.png', name: '基础祈愿值' },  // 9
  { type: 'points', value: 50, icon: 'https://oss.kigermap.com/frontend/assets/image/qiyun.png', name: '微量祈愿值' },    // 10
  { type: 'points', value: 20, icon: 'https://oss.kigermap.com/frontend/assets/image/qiyun.png', name: '少量祈愿值' }     // 11
])
